"""
Django settings for ODLS project.
...
SECRET_KEY = 'django-insecure-(6qotyw1)*m-z-zhzi-x+qg9gw=u^dmye!ym@n71_zg^44^#$7'
...
WSGI_APPLICATION = 'ODLS.wsgi.application'
...
SOCIAL_AUTH_REDIRECT_IS_HTTPS = False  # Set according to your server configuration

# Define the pipeline for social authentication
SOCIAL_AUTH_PIPELINE = (
    ...
    'core.pipeline.save_profile_picture',  # Add this line
)
